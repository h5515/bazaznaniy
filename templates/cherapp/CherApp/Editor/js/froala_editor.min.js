...
! function(e, t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : e.FroalaEditor = t() }(this, function() {
    ...
    V.RegisterPlugins = function(e) { for (var t = 0; t < e.length; t++) e[t].call(V) }, Object.assign(V, { DEFAULTS: { initOnClick: !1, pluginsEnabled: null }, MODULES: {}, PLUGINS: {}, VERSION: "3.2.0", INSTANCES: [], OPTS_MAPPING: {}, SHARED: {}, ID: 0 }), V.MODULES.node = function(a) {
        var n = a.$;
        ...
        return {
            ...
            isList: function C(e) { return !!e && 0 <= ["UL", "OL"].indexOf(e.tagName) },
            isLink: function m(e) { return !!e && e.nodeType === Node.ELEMENT_NODE && "a" === e.tagName.toLowerCase() },
            isElement: r,
            contents: s,
            isVoid: function v(e) { return e && e.nodeType === Node.ELEMENT_NODE && 0 <= V.VOID_ELEMENTS.indexOf((e.tagName || "").toLowerCase()) },
            hasFocus: function b(e) { return e === a.doc.activeElement && (!a.doc.hasFocus || a.doc.hasFocus()) && Boolean(r(e) || e.type || e.href || ~e.tabIndex) },
            isEditable: function L(e) { return (!e.getAttribute || "false" !== e.getAttribute("contenteditable")) && ["STYLE", "SCRIPT"].indexOf(e.tagName) < 0 },
            isDeletable: function E(e) { return e && e.nodeType === Node.ELEMENT_NODE && e.getAttribute("class") && 0 <= (e.getAttribute("class") || "").indexOf("fr-deletable") },
            hasClass: function y(e, t) { return e instanceof n && (e = e.get(0)), e && e.classList && e.classList.contains(t) },
            filter: function S(e) { return a.browser.msie ? e : { acceptNode: e } }
        }
        ...
        function C(e) { var t = e.replace(/;;/gi, ";"); return ";" !== (t = t.replace(/^;/gi, "")).charAt(t.length) && (t += ";"), t }
        ...
        function b(e) { var t = f.doc.createElement("DIV"); return t.innerText = e, t.textContent }
    ...
    V.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}"), V.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;\\/~+#-\\'*-_{}]*)|())", V.LinkRegExTLD = "((".concat(V.LinkRegExCommon, ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))"), V.LinkRegExHTTP = "((ftp|http|https):\\/\\/".concat(V.LinkRegExCommon, ")"), V.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@".concat(V.LinkRegExCommon, ")"), V.LinkRegExWWW = "(www\\.".concat(V.LinkRegExCommon, "\\.[a-z0-9-]{2,24})"), V.LinkRegEx = "(".concat(V.LinkRegExTLD, "|").concat(V.LinkRegExHTTP, "|").concat(V.LinkRegExWWW, "|").concat(V.LinkRegExAuth, ")").concat(V.LinkRegExEnd), V.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], V.MAIL_REGEX = /.+@.+\..+/i, V.MODULES.helpers = function(i) {
        ...
        return {
            ...
            isTouch: function C() { return "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch },
            sanitizeURL: function m(e) { return /^(https?:|ftps?:|)\/\//i.test(e) ? e : /^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\\]+)+)(\\)?$/i.test(e) ? e : new RegExp("^(".concat(V.LinkProtocols.join("|"), "):"), "i").test(e) ? e : e = encodeURIComponent(e).replace(/%23/g, "#").replace(/%2F/g, "/").replace(/%25/g, "%").replace(/mailto%3A/gi, "mailto:").replace(/file%3A/gi, "file:").replace(/sms%3A/gi, "sms:").replace(/tel%3A/gi, "tel:").replace(/notes%3A/gi, "notes:").replace(/data%3Aimage/gi, "data:image").replace(/blob%3A/gi, "blob:").replace(/%3A(\d)/gi, ":$1").replace(/webkit-fake-url%3A/gi, "webkit-fake-url:").replace(/%3F/g, "?").replace(/%3D/g, "=").replace(/%26/g, "&").replace(/&amp;/g, "&").replace(/%2C/g, ",").replace(/%3B/g, ";").replace(/%2B/g, "+").replace(/%40/g, "@").replace(/%5B/g, "[").replace(/%5D/g, "]").replace(/%7B/g, "{").replace(/%7D/g, "}") },
            isArray: function v(e) { return e && !Object.prototype.propertyIsEnumerable.call(e, "length") && "object" === N(e) && "number" == typeof e.length },
            ...
            HEXtoRGB: function L(e) { e = e.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, function(e, t, n, r) { return t + t + n + n + r + r }); var t = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e); return t ? "rgb(".concat(parseInt(t[1], 16), ", ").concat(parseInt(t[2], 16), ", ").concat(parseInt(t[3], 16), ")") : "" },
            isURL: function E(e) { return !!/^(https?:|ftps?:|)\/\//i.test(e) && (e = String(e).replace(/</g, "%3C").replace(/>/g, "%3E").replace(/"/g, "%22").replace(/ /g, "%20"), new RegExp("^".concat(V.LinkRegExHTTP).concat(V.LinkRegExEnd, "$"), "gi").test(e)) },
            ...
            scrollTop: function S() { return i.o_win.pageYOffset ? i.o_win.pageYOffset : i.o_doc.documentElement && i.o_doc.documentElement.scrollTop ? i.o_doc.documentElement.scrollTop : i.o_doc.body.scrollTop ? i.o_doc.body.scrollTop : 0 },
            scrollLeft: function T() { return i.o_win.pageXOffset ? i.o_win.pageXOffset : i.o_doc.documentElement && i.o_doc.documentElement.scrollLeft ? i.o_doc.documentElement.scrollLeft : i.o_doc.body.scrollLeft ? i.o_doc.body.scrollLeft : 0 },
            isInViewPort: function M(e) { var t = e.getBoundingClientRect(); return 0 <= (t = { top: Math.round(t.top), bottom: Math.round(t.bottom) }).top && t.bottom <= (window.innerHeight || document.documentElement.clientHeight) || t.top <= 0 && t.bottom >= (window.innerHeight || document.documentElement.clientHeight) }
        }
    }, V.MODULES.events = function(l) {
        var e, i = l.$,
            a = {};

        function s(e, t, n) { C(e, t, n) }
        ...
        function v() { for (var e in a) Object.prototype.hasOwnProperty.call(a, e) && delete a[e] }

        function b() { for (var e in l.shared._events) Object.prototype.hasOwnProperty.call(l.shared._events, e) && delete l.shared._events[e] }
        return {
            _init: function L() {
                l.shared.$_events = l.shared.$_events || [], l.shared._events = {},
                    ...
                    function t() { s(l.$el, "click mouseup mousemove mousedown touchstart touchend dragenter dragover dragleave dragend drop dragstart", function(e) { m(e.type, [e]) }), h("mousedown", function() { for (var e = 0; e < V.INSTANCES.length; e++) V.INSTANCES[e] !== l && V.INSTANCES[e].popups && V.INSTANCES[e].popups.areVisible() && V.INSTANCES[e].$el.find(".fr-marker").remove() }) }(),
                    function n() { s(l.$win, l._mousedown, function(e) { m("window.mousedown", [e]), f() }), s(l.$win, l._mouseup, function(e) { m("window.mouseup", [e]) }), s(l.$win, "cut copy keydown keyup touchmove touchend", function(e) { m("window.".concat(e.type), [e]) }) }(),
                    function r() { s(l.$doc, "dragend drop", function(e) { m("document.".concat(e.type), [e]) }) }(),
                    function o() { s(l.$el, "keydown keypress keyup input", function(e) { m(e.type, [e]) }) }(),
                    function i() { s(l.$el, "focus", function(e) { u() && (c(!1), !1 === d && m(e.type, [e])) }), s(l.$el, "blur", function(e) { u() && !0 === d && (m(e.type, [e]), f()) }), C(l.$el, "mousedown", '[contenteditable="true"]', function() { p(), l.$el.blur() }), h("focus", function() { d = !0 }), h("blur", function() { d = !1 }) }(), f(),
                    function a() { s(l.$el, "cut copy paste beforepaste", function(e) { m(e.type, [e]) }) }(), h("destroy", v), h("shared.destroy", b)
            },
            on: h,
            trigger: m,
        ...
        return {
            ...
            _backspace: function d(e) {
                ...
                if (n) {
                    ...
                    r.length && "BR" === r[r.length - 1].tagName && C(r[r.length - 1]).remove(), C(t).find(g.html.blockTagsQuery()).not("ol, ul, table").each(function() { this.parentNode === t && C(this).replaceWith(C(this).html() + (g.node.isEmpty(this) ? "" : "<br>")) });
                    ...
                    if (C(e).replaceWith(V.MARKERS), a.parentNode && "LI" === a.parentNode.tagName) {
                        ...
                        g.node.isBlock(s) ? (C(t).find(g.html.blockTagsQuery()).not("ol, ul, table").each(function() { this.parentNode === t && C(this).replaceWith(C(this).html() + (g.node.isEmpty(this) ? "" : "<br>")) }), C(s).append(C(t).html())) : C(a).before(C(t).html())
                    } else {
            ...
            _del: function f(e) {
                var t, n = m(e),
                    r = n.nextSibling;
                if (r) {
                    (t = g.node.contents(r)).length && "BR" === t[0].tagName && C(t[0]).remove(), C(r).find(g.html.blockTagsQuery()).not("ol, ul, table").each(function() { this.parentNode === r && C(this).replaceWith(C(this).html() + (g.node.isEmpty(this) ? "" : "<br>")) });
        ...
        function C(e, t) { return !!e && (e !== u.$wp.get(0) && (e.nextSibling && e.nextSibling.nodeType === Node.TEXT_NODE && 0 === e.nextSibling.textContent.replace(/\u200b/g, "").length ? C(e.nextSibling, t) : !(e.nextSibling && (!e.previousSibling || "BR" !== e.nextSibling.tagName || e.nextSibling.nextSibling)) && (e.parentNode === t || C(e.parentNode, t)))) }
            ...
            enter: function v(e) {
                ...
                0 < h(t).parentsUntil(u.$el, "BLOCKQUOTE").length && (r = !0), h(t).parentsUntil(u.$el, "TD, TH").length && (r = !1), i(t) ? !c(t) || e || r ? l(t, e, r) : u.cursorLists._endEnter(t) : a(t) ? !c(t) || e || r ? function s(e, t, n) {
                        ...
                        if (o && "BLOCKQUOTE" === o.tagName)
                            if (g(e, o)) { if (!t) return (r = u.html.defaultTag()) ? h(o).before("<".concat(r, ">").concat(V.MARKERS, "<br></").concat(r, ">")) : h(o).before("".concat(V.MARKERS, "<br>")), h(e).remove(), !1 } else C(e, o) ? l(e, t, !0) : m(e, t, !0);
        ...
        function g() {
            if (10 < e && (f[p(N("0ppecjvc=="))](), setTimeout(function() { L.FE = null }, 10)), !f.$box) return !1;
            ...
            _init: function x() {
                ...
                for (var n, r, o, i = !(f.ul = !0), a = 0, s = 0; s < e.length; s++) {
                    ...
                    if (c === N(p(N("LGnD1KNZf1CPBYCAZB-8F3UDSLLSG1VFf1A3C2=="))) || 0 <= c.indexOf(M, c.length - M.length) || C(M) || m()) {
                        if (null !== (n = l[1]) && !(0 == n.indexOf("TRIAL") ? (n = new Date(n.replace(/TRIAL/, "")), new Date(n) < new Date && (E = y, 1)) : new Date(n) < new Date(N(S))) || !(0 < (M || "").length) || C(M) || m()) { f.ul = !1; break }
                        i = !0, T = E, a = l[0] || -1
                    }
                }
                var d = new Image;
        ...
        function L(e, t) { var n = e; for (var r in t) Object.prototype.hasOwnProperty.call(t, r) && (n += "id" === r ? "#".concat(t[r]) : "class" === r ? ".".concat(t[r]) : "[".concat(r, '="').concat(t[r], '"]')); return n }

        function E(e, t) { return !(!e || e.nodeType !== Node.ELEMENT_NODE) && (e.matches || e.matchesSelector || e.msMatchesSelector || e.mozMatchesSelector || e.webkitMatchesSelector || e.oMatchesSelector).call(e, t) }
        ...
        function n(e, t) {
            var n;
            if (void 0 === t && (t = {}), t.style && delete t.style, v.selection.isCollapsed()) { v.markers.insert(), v.$el.find(".fr-marker").replaceWith(f(e, t) + V.INVISIBLE_SPACE + V.MARKERS + function a(e) { return "</".concat(e, ">") }(e)), v.selection.restore() } else {
                var r;
                v.selection.save(), C(v.$el.find('.fr-marker[data-type="true"]').length && v.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling, e, t);
                do { for (r = v.$el.find("".concat(L(e, t), " > ").concat(L(e, t))), n = 0; n < r.length; n++) r[n].outerHTML = r[n].innerHTML } while (r.length);
                v.el.normalize();
                var o = v.el.querySelectorAll(".fr-marker");
                for (n = 0; n < o.length; n++) { var i = b(o[n]);!0 === i.data("type") ? E(i.get(0).nextSibling, L(e, t)) && i.next().prepend(i) : E(i.get(0).previousSibling, L(e, t)) && i.prev().append(i) }
                v.selection.restore()
            }
        }
            ...
            if (l) {
                ...
                v.selection.text().replace(/\u200B/g, "").length || function m(e, t) {
                    if (e && t) {
                        ...
                        Array.isArray(e.childNodes) && e.childNodes.forEach(function(e) { m(e, t) })
                    }
                }(c, l);
        ...
        function m(e, t, n) {
            ...
            if ((a = a.not(s)).length) {
                ...
                b(a.get(0)).replaceWith(h.replace(/<span id="fr-break"><\/span>/g, function() { return u }))
            }
        }
        ...
        function s() { var e = ""; return E.win.getSelection ? e = E.win.getSelection() : E.doc.getSelection ? e = E.doc.getSelection() : E.doc.selection && (e = E.doc.selection.createRange().text), e.toString() }

        function L() { return E.win.getSelection ? E.win.getSelection() : E.doc.getSelection ? E.doc.getSelection() : E.doc.selection.createRange() }

        function d(e) {
            var t = L(),
                n = [];
            if (t && t.getRangeAt && t.rangeCount) { n = []; for (var r = 0; r < t.rangeCount; r++) n.push(t.getRangeAt(r)) } else n = E.doc.createRange ? [E.doc.createRange()] : [];
            return void 0 !== e ? n[e] : n
        }

        function S() { var e = L(); try { e.removeAllRanges ? e.removeAllRanges() : e.empty ? e.empty() : e.clear && e.clear() } catch (t) {} }
        ...
        function N(e, t, n) {
            var r, o = e.previousSibling,
                i = e.nextSibling;
            return o && i && o.nodeType === Node.TEXT_NODE && i.nodeType === Node.TEXT_NODE ? (r = o.textContent.length, n ? (i.textContent = o.textContent + i.textContent, y(o).remove(), y(e).remove(), E.opts.htmlUntouched || E.spaces.normalize(i), function() { t.setStart(i, r) }) : (o.textContent += i.textContent, y(i).remove(), y(e).remove(), E.opts.htmlUntouched || E.spaces.normalize(o), function() { t.setEnd(o, r) })) : o && !i && o.nodeType === Node.TEXT_NODE ? (r = o.textContent.length, n ? (E.opts.htmlUntouched || E.spaces.normalize(o), function() { t.setStart(o, r) }) : (E.opts.htmlUntouched || E.spaces.normalize(o), function() { t.setEnd(o, r) })) : !(!i || o || i.nodeType !== Node.TEXT_NODE) && (n ? (E.opts.htmlUntouched || E.spaces.normalize(i), function() { t.setStart(i, 0) }) : (E.opts.htmlUntouched || E.spaces.normalize(i), function() { t.setEnd(i, 0) }))
        }
        ...
        function O() { return 0 === y(this).find("fr-inner").length }

        function p() { try { if (!E.$wp) return !1; for (var e = d(0).commonAncestorContainer; e && !E.node.isElement(e);) e = e.parentNode; return !!E.node.isElement(e) } catch (t) { return !1 } }
        ...
        return {
            ...
            remove: function w() {
                ...
                if (function b() {
                    ...
                    if (s.length) E.$el.find(".fr-marker").remove(), s.append(V.INVISIBLE_SPACE + V.MARKERS).removeAttr("data-first"), s.attr("data-text") && s.replaceWith(s.html());
                        ...
                        for (E.$el.find("table").filter(function() { return 0 < y(this).find("[data-del-cell]").length && y(this).find("[data-del-cell]").length === y(this).find("td, th").length }).remove(), E.$el.find("[data-del-cell]").removeAttr("data-del-cell"), r = E.$el.find('.fr-marker[data-type="true"]'), e = 0; e < r.length; e++) {
                            var l = r[e],
                                c = l.nextSibling,
            ...
            setAtEnd: i,
            setAtStart: r,
            setBefore: function g(e, t) { void 0 === t && (t = !0); for (var n = e.previousSibling; n && n.nodeType === Node.TEXT_NODE && 0 === n.textContent.length;) n = n.previousSibling; return n ? (E.node.isBlock(n) ? i(n) : "BR" === n.tagName ? y(n).before(V.MARKERS) : y(n).after(V.MARKERS), !0) : !!t && (E.node.isBlock(e) ? r(e) : y(e).before(V.MARKERS), !0) },
            setAfter: function C(e, t) { void 0 === t && (t = !0); for (var n = e.nextSibling; n && n.nodeType === Node.TEXT_NODE && 0 === n.textContent.length;) n = n.nextSibling; return n ? (E.node.isBlock(n) ? r(n) : y(n).before(V.MARKERS), !0) : !!t && (E.node.isBlock(e) ? i(e) : y(e).after(V.MARKERS), !0) },
            rangeElement: f
        }
        ...
        function d() { return O.opts.enter === V.ENTER_P ? "p" : O.opts.enter === V.ENTER_DIV ? "div" : O.opts.enter === V.ENTER_BR ? null : void 0 }
        ...
        function p() { return V.BLOCK_TAGS.join(", ") }
        ...
        function n(e) {
            ...
            for (var t = O.doc.createTreeWalker(e, NodeFilter.SHOW_TEXT, O.node.filter(function(e) { return null !== e.textContent.match(/([ \n]{2,})|(^[ \n]{1,})|([ \n]{1,}$)/g) }), !1); t.nextNode();) {
                var n = t.currentNode;
                if (!s(n.parentNode, !0)) {
        ...
        function g() { O.opts.htmlUntouched || (e(), t(), n(), O.spaces.normalize(null, !0), O.html.fillEmptyBlocks(), O.clean.lists(), O.clean.tables(), O.clean.toHTML5(), O.html.cleanBRs()), O.selection.restore(), o(), O.placeholder.refresh() }

        function o() { O.node.isEmpty(O.el) && (null !== d() ? O.el.querySelector(p()) || O.el.querySelector("".concat(O.opts.htmlDoNotWrapTags.join(":not(.fr-marker),"), ":not(.fr-marker)")) || (O.core.hasFocus() ? (O.$el.html("<".concat(d(), ">").concat(V.MARKERS, "<br/></").concat(d(), ">")), O.selection.restore()) : O.$el.html("<".concat(d(), "><br/></").concat(d(), ">"))) : O.el.querySelector("*:not(.fr-marker):not(br)") || (O.core.hasFocus() ? (O.$el.html("".concat(V.MARKERS, "<br/>")), O.selection.restore()) : O.$el.html("<br/>"))) }

        function C(e, t) { return r(e, "<".concat(t, "[^>]*?>([\\w\\W]*)</").concat(t, ">"), 1) }

        function m(e, t) { var n = h("<div ".concat(r(e, "<".concat(t, "([^>]*?)>"), 1) || "", ">")); return O.node.rawAttributes(n.get(0)) }

        function v(e) { return (r(e, "<!DOCTYPE([^>]*?)>", 0) || "<!DOCTYPE html>").replace(/\n/g, " ").replace(/ {2,}/g, " ") }

        function b(e, t) { O.opts.htmlExecuteScripts ? e.html(t) : e.get(0).innerHTML = t }
        ...
        function B() { for (var e = O.el.querySelectorAll("input, textarea"), t = 0; t < e.length; t++) "checkbox" !== e[t].type && "radio" !== e[t].type || (e[t].checked ? e[t].setAttribute("checked", e[t].checked) : O.$(e[t]).removeAttr("checked")), e[t].getAttribute("value") && e[t].setAttribute("value", e[t].value) }
        ...
        function L() { u(), O.placeholder && setTimeout(O.placeholder.refresh, 0) }
        return {
            defaultTag: d,
            isPreformatted: s,
            emptyBlocks: i,
            emptyBlockTagsQuery: function E() { return "".concat(V.BLOCK_TAGS.join(":empty, "), ":empty") },
            blockTagsQuery: p,
            fillEmptyBlocks: function y(e) {
                var t = i(e);
                O.node.isEmpty(O.el) && O.opts.enter === V.ENTER_BR && t.push(O.el);
                for (var n = 0; n < t.length; n++) { var r = t[n]; "false" === r.getAttribute("contenteditable") || r.querySelector("".concat(O.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),"), ":not(.fr-marker)")) || O.node.isVoid(r) || "TABLE" !== r.tagName && "TBODY" !== r.tagName && "TR" !== r.tagName && "UL" !== r.tagName && "OL" !== r.tagName && r.appendChild(O.doc.createElement("br")) }
            ...
            cleanWhiteTags: u,
            cleanBlankSpaces: n,
            blocks: function S() { return O.$el.get(0).querySelectorAll(p()) },
            getDoctype: w,
            set: function T(e) {
            ...
            get: function _(e, t) {
                ...
                if (B(), !O.opts.useClasses && !t) {
                    ...
                    for (r = 0; r < O.doc.styleSheets.length; r++) {
                        var c = void 0,
                            d = 0;
                        try { c = O.doc.styleSheets[r].cssRules, O.doc.styleSheets[r].ownerNode && "STYLE" === O.doc.styleSheets[r].ownerNode.nodeType && (d = 1) } catch (x) {}
                        if (c)
                            for (var f = 0, p = c.length; f < p; f++)
                                if (c[f].selectorText && 0 < c[f].style.cssText.length) {
                                    var u = c[f].selectorText.replace(/body |\.fr-view /g, "").replace(/::/g, ":"),
                                        h = void 0;
                                    try { h = O.el.querySelectorAll(u) } catch (x) { h = [] }
                ...
                return "string" == typeof A && (n = A), n = (n = n.replace(/<pre(?:[\w\W]*?)>(?:[\w\W]*?)<\/pre>/g, function(e) { return e.replace(/<br>/g, "\n") })).replace(/<meta((?:[\w\W]*?)) data-fr-http-equiv="/g, '<meta$1 http-equiv="')
            },
            ...
            insert: function N(e, t, n) {
                var r;
                if (O.selection.isCollapsed() || O.selection.remove(), r = t ? e : O.clean.html(e), e.indexOf('class="fr-marker"') < 0 && (r = function a(e) { var t = O.doc.createElement("div"); return t.innerHTML = e, O.selection.setAtEnd(t, !0), t.innerHTML }(r)), O.node.isEmpty(O.el) && !O.opts.keepFormatOnDelete && f(r)) O.el.innerHTML = r;
                else {
            ...
            wrap: t,
            unwrap: function A() { O.$el.find("div.fr-temp-div").each(function() { this.previousSibling && this.previousSibling.nodeType === Node.TEXT_NODE && h(this).before("<br>"), h(this).attr("data-empty") || !this.nextSibling || O.node.isBlock(this.nextSibling) && !h(this.nextSibling).hasClass("fr-temp-div") ? h(this).replaceWith(h(this).html()) : h(this).replaceWith("".concat(h(this).html(), "<br>")) }), O.$el.find(".fr-temp-div").removeClass("fr-temp-div").filter(function() { return "" === h(this).attr("class") }).removeAttr("class") },
            escapeEntities: function x(e) { return e.replace(/</gi, "&lt;").replace(/>/gi, "&gt;").replace(/"/gi, "&quot;").replace(/'/gi, "&#39;") },
            checkIfEmpty: o,
            extractNode: C,
            extractNodeAttrs: m,
            extractDoctype: v,
            cleanBRs: function R() { for (var e = O.el.getElementsByTagName("br"), t = 0; t < e.length; t++) c(e[t]) },
            _init: function H() {
        ...
        function v(e) { if (e >= V.KEYCODE.ARROW_LEFT && e <= V.KEYCODE.ARROW_DOWN) return !0 }
        ...
        return { _init: function M() { d.events.on("keydown", L), d.events.on("input", e), d.events.on("mousedown", a), d.events.on("keyup input", E), d.events.on("keypress", i), d.events.on("keydown", s), d.events.on("keyup", c), d.events.on("destroy", T), d.events.on("html.inserted", c), d.events.on("cut", t), d.opts.multiLine && d.events.on("click", S) }, ctrlKey: m, isCharacter: b, isArrow: v, forceUndo: function N() { n && (clearTimeout(n), d.undo.saveStep(), r = null) }, isIME: function A() { return p }, isBrowserAction: function x(e) { var t = e.which; return m(e) || t === V.KEYCODE.F5 }, positionCaret: l }
    }, Object.assign(V.DEFAULTS, { pastePlain: !1, pasteDeniedTags: ["colgroup", "col", "meta"], pasteDeniedAttrs: ["class", "id"], pasteAllowedStyleProps: [".*"], pasteAllowLocalImages: !1 }), V.MODULES.paste = function(N) {
        var a, s, i, A, x = N.$;

        function n(e, t) { try { N.win.localStorage.setItem("fr-copied-html", e), N.win.localStorage.setItem("fr-copied-text", t) } catch (n) {} }

        function e(e) {
            var t = N.html.getSelected();
            n(t, x(N.doc.createElement("div")).html(t).text()), "cut" === e.type && (N.undo.saveStep(), setTimeout(function() { N.selection.save(), N.html.wrap(), N.selection.restore(), N.events.focus(), N.undo.saveStep() }, 0))
        }
        var l = !1;
        ...
        function r(e) {
            ...
            if (e && e.dataTransfer && e.dataTransfer.getData) {
                ...
                if (a = "", /text\/rtf/.test(t) && (s = e.dataTransfer.getData("text/rtf")), /text\/html/.test(t) ? a = e.dataTransfer.getData("text/html") : /text\/rtf/.test(t) && N.browser.safari ? a = s : /text\/plain/.test(t) && !this.browser.mozilla && (a = N.html.escapeEntities(e.dataTransfer.getData("text/plain")).replace(/\n/g, "<br>")), "" !== a) { N.keys.forceUndo(), A = N.snapshot.get(), N.selection.save(), N.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-helper"); var o = N.markers.insertAtPoint(e); if (N.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-placeholder"), N.$el.find(".fr-marker-helper").addClass("fr-marker").removeClass("fr-marker-helper"), N.selection.restore(), N.selection.remove(), N.$el.find(".fr-marker-placeholder").addClass("fr-marker").removeClass("fr-marker-placeholder"), !1 !== o) { var i = N.el.querySelector(".fr-marker"); return x(i).replaceWith(V.MARKERS), N.selection.restore(), d(), e.preventDefault && (e.stopPropagation(), e.preventDefault()), !1 } } else a = null
            }
        }
        ...
        function o(e, t, n) {
            ...
            var l = !1;
            if (!t)
                if ((l = function E(e) { var t = null; try { t = N.win.localStorage.getItem("fr-copied-text") } catch (n) {} return !(!t || x("<div>").html(e).text().replace(/\u00A0/gi, " ").replace(/\r|\n/gi, "") !== t.replace(/\u00A0/gi, " ").replace(/\r|\n/gi, "")) }(e)) && (e = N.win.localStorage.getItem("fr-copied-html")), l) e = N.clean.html(e, N.opts.pasteDeniedTags, N.opts.pasteDeniedAttrs);
                else {
                    var c = N.opts.htmlAllowedStyleProps;
                    N.opts.htmlAllowedStyleProps = N.opts.pasteAllowedStyleProps, N.opts.htmlAllowComments = !1, e = (e = (e = e.replace(/<span class="Apple-tab-span">\s*<\/span>/g, O(N.opts.tabSpaces || 4))).replace(/<span class="Apple-tab-span" style="white-space:pre">(\t*)<\/span>/g, function(e, t) { return O(t.length * (N.opts.tabSpaces || 4)) })).replace(/\t/g, O(N.opts.tabSpaces || 4)), e = N.clean.html(e, N.opts.pasteDeniedTags, N.opts.pasteDeniedAttrs), N.opts.htmlAllowedStyleProps = c, N.opts.htmlAllowComments = !0, e = (e = (e = w(e)).replace(/\r/g, "")).replace(/^ */g, "").replace(/ *$/g, "")
                ...
                return function i(e) { for (var t = N.node.contents(e), n = 0; n < t.length; n++) t[n].nodeType !== Node.TEXT_NODE && t[n].nodeType !== Node.ELEMENT_NODE ? t[n].parentNode.removeChild(t[n]) : i(t[n]) }(r), r.innerHTML
            }(e));
            ...
            }! function M() { N.events.trigger("paste.after") }(), N.undo.saveStep(A), A = null, N.undo.saveStep()
        }
        ...
        function p() { N.el.removeEventListener("copy", e), N.el.removeEventListener("cut", e), N.el.removeEventListener("paste", t) }
        return { _init: function u() { N.el.addEventListener("copy", e), N.el.addEventListener("cut", e), N.el.addEventListener("paste", t, { capture: !0 }), N.events.on("drop", r), N.browser.msie && N.browser.version < 11 && (N.events.on("mouseup", function(e) { 2 === e.button && (setTimeout(function() { l = !1 }, 50), l = !0) }, !0), N.events.on("beforepaste", t)), N.events.on("destroy", p) }, cleanEmptyTagsAndDivs: w, getRtfClipboard: function h() { return s }, saveCopiedText: n, clean: o }
        ...
        function b(r) {
            ...
            return {
                ...
                _editorMouseup: function() { o.isVisible() && l() && 0 < o.findVisible("input:focus, textarea:focus, button:focus, select:focus").length && f.events.disableBlur() },
        ...
        return f.shared.exit_flag = !1, {
            _init: function y() { r = window.innerHeight, f.events.on("shared.destroy", e, !0), f.events.on("window.mousedown", t), f.events.on("window.touchmove", v), f.events.$on(d(f.o_win), "scroll", v), f.events.on("mousedown", function(e) { C() && (e.stopPropagation(), f.$el.find(".fr-marker").remove(), t(), f.events.disableBlur()) }) },
            ...
            get: function T(e) { var t = u[e]; return t && !t.data("inst".concat(f.id)) && L(b(e), e), t },
            ...
            hide: n,
            onHide: function N(e, t) { f.events.on("popups.hide.".concat(e), t) },
            hideAll: m,
            setContainer: h,
            ...
            onRefresh: function x(e, t) { f.events.on("popups.refresh.".concat(e), t) },
            onShow: function O(e, t) { f.events.on("popups.show.".concat(e), t) },
            isVisible: g,
            setFileListHeight: o,
            areVisible: C,
        ...
        function L() { f.shared.$f_el && (f.events.disableBlur(), f.shared.$f_el.blur(), f.shared.$f_el = null), !1 !== f.events.trigger("toolbar.focusEditor") && (f.events.disableBlur(), f.$el.get(0).focus(), f.events.focus()) }
        ...
        return {
            ...
            focusModal: function M(e) { f.core.hasFocus() || (f.events.disableBlur(), f.events.focus()), f.accessibility.saveSelection(), f.events.disableBlur(), f.el.blur(), f.selection.clear(), f.events.disableBlur(), f.shared.with_kb ? e.find(".fr-command[tabIndex], [tabIndex]").first().focus() : e.find("[tabIndex]").first().focus() },
            focusEditor: L,
            focusPopupButton: E,
        ...
        function v() { clearTimeout(u), u = setTimeout(n, 50) }
        return {
            _init: function b() { g.opts.toolbarInline ? g.events.on("toolbar.show", n) : (g.events.on("mouseup", v), g.events.on("keyup", v), g.events.on("blur", v), g.events.on("focus", v), g.events.on("contentChanged", v), g.helpers.isMobile() && g.events.$on(g.$doc, "selectionchange", n)), g.events.on("shared.destroy", r) },
            build: m,
            ...
            addButtons: function T(e) { for (var t = 0; t < e.length; t++) a.push(e) },
            getButtons: C,
        ...
        function i(e, t, n, r) {
            ...
            var s = function l(e, t) { var n = e.outerWidth(!0); return t + n > L.$sc.get(0).clientWidth - 10 && (t = L.$sc.get(0).clientWidth - n - 10), t < 0 && (t = 10), t }(n, e);
        ...
        function n(e) {
            if (e.offsetWidth) {
                ...
                var u = L.helpers.getPX(t.data("top")),
                    ...
                    g = r.top && function v() { return d < s + u && s + u <= d + f - n }() && (L.helpers.isInViewPort(L.$sc.get(0)) || "body" === L.opts.scrollableContainer),
                    C = r.bottom && function b() { return d + n < s + o - h && s + o - h < d + f }();
                if (g || C) {
        ...
        return {
            _init: function s() {
                ! function e() {
                    ...
                    }, !0)) : ("body" !== L.opts.scrollableContainer && L.events.$on(E(L.opts.scrollableContainer), "scroll", a, !0), L.events.$on(E(L.o_win), "scroll", a, !0), L.events.$on(E(L.o_win), "resize", a, !0), L.events.on("initialized", a), L.events.on("focus", a), L.events.$on(E(L.o_win), "resize", "textarea", a, !0)), L.events.on("destroy", function() { L._stickyElements = [] })
                }()
            },
            ...
            addSticky: function c(e) { e.addClass("fr-sticky"), L.helpers.isIOS() && e.addClass("fr-sticky-ios"), e.removeClass("fr-sticky"), L._stickyElements.push(e.get(0)) },
            refresh: a,
            at: i,
            getBoundingRect: o
        }
        ...
        function b() { var e = C.helpers.screenSize(); return t[m = e] }
        ...
        function L() {
            for (var e = C.$tb.find(".fr-more-toolbar"), c = "", t = 0; t < e.length; t++) {
                ...
                d.hasClass("fr-expanded") ? function() {
                    ...
                    if (e.each(function(e, t) { n += v(t).outerWidth() + r + o }), C.$tb.outerWidth() < n) {
        ...
        function o(e) { return (!e || "blur" !== e.type || document.activeElement !== C.el) && (!(!e || "keydown" !== e.type || !C.keys.ctrlKey(e)) || (!!C.button.getButtons(".fr-dropdown.fr-active").next().find(C.o_doc.activeElement).length || void(!1 !== C.events.trigger("toolbar.hide") && C.$tb.hide()))) }
        ...
        function a(e) { clearTimeout(i), e && e.which === V.KEYCODE.ESC || (i = setTimeout(n, C.opts.typingTimer)) }

        function s() { C.events.on("window.mousedown", o), C.events.on("keydown", o), C.events.on("blur", o), C.events.$on(C.$tb, "transitionend", ".fr-more-toolbar", function() { C.position.forSelection(C.$tb) }), C.helpers.isMobile() || C.events.on("window.mouseup", n), C.helpers.isMobile() ? C.helpers.isIOS() || (C.events.on("window.touchend", n), C.browser.mozilla && setInterval(n, 200)) : C.events.on("window.keyup", a), C.events.on("keydown", function(e) { e && e.which === V.KEYCODE.ESC && o() }), C.events.on("keydown", function(e) { if (e.which === V.KEYCODE.ALT) return e.stopPropagation(), !1 }, !0), C.events.$on(C.$wp, "scroll.toolbar", n), C.events.on("commands.after", n), C.helpers.isMobile() && (C.events.$on(C.$doc, "selectionchange", a), C.events.$on(C.$doc, "orientationchange", n)) }

        function l() { C.$tb.html("").removeData().remove(), C.$tb = null, C.$second_tb && (C.$second_tb.html("").removeData().remove(), C.$second_tb = null) }

        function c() { C.$box.removeClass("fr-top fr-bottom fr-inline fr-basic"), C.$box.find(".fr-sticky-dummy").remove() }
        ...
        function d() {
            C.opts.theme && C.$tb.addClass("".concat(C.opts.theme, "-theme")), 1 < C.opts.zIndex && C.$tb.css("z-index", C.opts.zIndex + 1), "auto" !== C.opts.direction && C.$tb.removeClass("fr-ltr fr-rtl").addClass("fr-".concat(C.opts.direction)), C.helpers.isMobile() ? C.$tb.addClass("fr-mobile") : C.$tb.addClass("fr-desktop"), C.opts.toolbarContainer ? (C.opts.toolbarInline && (s(), o()), C.opts.toolbarBottom ? C.$tb.addClass("fr-bottom") : C.$tb.addClass("fr-top")) : function e() { C.opts.toolbarInline ? (C.$sc.append(C.$tb), C.$tb.data("container", C.$sc), C.$tb.addClass("fr-inline"), s(), C.opts.toolbarBottom = !1) : (C.opts.toolbarBottom && !C.helpers.isIOS() ? (C.$box.append(C.$tb), C.$tb.addClass("fr-bottom"), C.$box.addClass("fr-bottom")) : (C.opts.toolbarBottom = !1, C.$box.prepend(C.$tb), C.$tb.addClass("fr-top"), C.$box.addClass("fr-top")), C.$tb.addClass("fr-basic"), C.opts.toolbarSticky && (C.opts.toolbarStickyOffset && (C.opts.toolbarBottom ? C.$tb.css("bottom", C.opts.toolbarStickyOffset) : C.$tb.css("top", C.opts.toolbarStickyOffset)), C.position.addSticky(C.$tb))) }(),
                ...
                function n() { C.events.$on(v(C.o_win), "resize", r), C.events.$on(v(C.o_win), "orientationchange", r) }(), C.accessibility.registerToolbar(C.$tb), C.events.$on(C.$tb, "".concat(C._mousedown, " ").concat(C._mouseup), function(e) { var t = e.originalEvent ? e.originalEvent.target || e.originalEvent.originalTarget : null; if (t && "INPUT" !== t.tagName && !C.edit.isDisabled()) return e.stopPropagation(), e.preventDefault(), !1 }, !0), C.helpers.isMobile() && C.events.$on(C.$tb, "click", function() { C.$el.focus() }), C.events.$on(C.$tb, "transitionend", ".fr-more-toolbar", function() { C.$box.hasClass("fr-fullscreen") && (C.opts.height = C.o_win.innerHeight - (C.opts.toolbarInline ? 0 : C.$tb.outerHeight() + (C.$second_tb ? C.$second_tb.outerHeight() : 0)), C.size.refresh()) })
        }
        var f = !1;
        return {
            _init: function p() {
                ...
                C.opts.toolbarInline || C.opts.toolbarBottom || (C.$second_tb = v(C.doc.createElement("div")).attr("class", "second-toolbar"), C.$box.append(C.$second_tb), (!1 !== C.ul || C.opts.attribution) && C.$second_tb.prepend(V.POWERED_BY)), C.opts.toolbarContainer ? (C.shared.$tb ? (C.$tb = C.shared.$tb, C.opts.toolbarInline && s()) : (C.shared.$tb = v(C.doc.createElement("DIV")), C.shared.$tb.addClass("fr-toolbar"), C.$tb = C.shared.$tb, v(C.opts.toolbarContainer).append(C.$tb), d(), C.$tb.data("instance", C)), C.opts.toolbarInline ? C.$box.addClass("fr-inline") : C.$box.addClass("fr-basic"), C.events.on("focus", function() { C.$tb.data("instance", C) }, !0), C.opts.toolbarInline = !1) : C.opts.toolbarInline ? (C.$box.addClass("fr-inline"), C.shared.$tb ? (C.$tb = C.shared.$tb, s()) : (C.shared.$tb = v(C.doc.createElement("DIV")), C.shared.$tb.addClass("fr-toolbar"), C.$tb = C.shared.$tb, d())) : (C.$box.addClass("fr-basic"), C.$tb = v(C.doc.createElement("DIV")), C.$tb.addClass("fr-toolbar"), d(), C.$tb.data("instance", C)), C.events.on("destroy", c, !0), C.events.on(C.opts.toolbarInline || C.opts.toolbarContainer ? "shared.destroy" : "destroy", l, !0), C.events.on("edit.on", function() { C.$tb.removeClass("fr-disabled").removeAttr("aria-disabled") }), C.events.on("edit.off", function() { C.$tb.addClass("fr-disabled").attr("aria-disabled", !0) }),
                    function e() { C.events.on("shortcut", function(e, t, n) { var r; if (t && !n ? r = C.$tb.find('.fr-command[data-cmd="'.concat(t, '"]')) : t && n && (r = C.$tb.find('.fr-command[data-cmd="'.concat(t, '"][data-param1="').concat(n, '"]'))), r.length && (e.preventDefault(), e.stopPropagation(), r.parents(".fr-toolbar").data("instance", C), "keydown" === e.type)) return C.button.exec(r), !1 }) }()
            },
            hide: o,
            show: function u() {
            ...
            showInline: n,
            disable: function h() {!f && C.$tb && (C.$tb.find(".fr-btn-grp > .fr-command, .fr-more-toolbar > .fr-command").addClass("fr-disabled fr-no-refresh").attr("aria-disabled", !0), f = !0) },
            enable: function g() { f && C.$tb && (C.$tb.find(".fr-btn-grp > .fr-command, .fr-more-toolbar > .fr-command").removeClass("fr-disabled fr-no-refresh").attr("aria-disabled", !1), f = !1), C.button.bulkRefresh() },
    ...
    var c = ["scroll", "wheel", "touchmove", "touchstart", "touchend"],
        ...
        h = function h(e, t) { return new v(e, t) },
        g = function g(e) { return e && "string" == typeof e ? e.replace(/^\s*>/g, ":scope >").replace(/,\s*>/g, ", :scope >") : e },
        C = function C(e) { return "function" == typeof e && "number" != typeof e.nodeType },
        m = h;
    h.fn = h.prototype = {
        constructor: h,
        length: 0,
        ...
        wrapAll: function(e) { var t; return this[0] && (C(e) && (e = e.call(this[0])), t = h(e, this[0].ownerDocument).eq(0).clone(!0), this[0].parentNode && t.insertBefore(this[0]), t.map(function() { for (var e = this; e.firstElementChild;) e = e.firstElementChild; return e }).append(this)), this },
        ...
        wrap: function(t) { var n = C(t); return this.each(function(e) { m(this).wrapAll(n ? t.call(this, e) : t) }) },
        ...
        attr: function(e, t) {
            if ("object" === N(e)) { for (var n in e) Object.prototype.hasOwnProperty.call(e, n) && null !== e[n] && this.attr(n, e[n]); return this }
        ...
        data: function(e, t) { if (void 0 !== t) { for (var n = 0; n < this.length; n++) "object" !== N(this[n]["data-" + e] = t) && "function" != typeof t && this[n].setAttribute && this[n].setAttribute("data-" + e, t); return this } if (void 0 !== t) return this.attr("data-" + e, t); if (0 === this.length) return undefined; for (var r = 0; r < this.length; r++) { var o = this[r]["data-" + e]; if (null == o && this[r].getAttribute && (o = this[r].getAttribute("data-" + e)), void 0 !== o && null != o) return o } return undefined },
        ...
        find: function(e) {
            ...
            var o = function o(e) { return "object" === ("undefined" == typeof HTMLElement ? "undefined" : N(HTMLElement)) ? e instanceof HTMLElement : e && "object" === N(e) && null !== e && 1 === e.nodeType && "string" == typeof e.nodeName };
            e = g(e);
        ...
        closest: function(e) { for (var t = 0; t < this.length; t++) { var n = this[t].closest && this[t].closest(e); if (n) return m(n) } return m() },
        html: function(e) {
    ...
    var v = function v(e, t) {
        if (!e) return this;
        if ("string" == typeof e && "<" === e[0]) { var n = document.createElement("DIV"); return n.innerHTML = e, m(n.firstElementChild) }
    ...
    return b.Bootstrap = function(e, t, n) {
        ...
        var t = function() { "TEXTAREA" !== e && (this._original_html = this._original_html || this.$oel.html()), this.$box = this.$box || this.$oel, this.opts.fullPage && (this.opts.iframe = !0), this.opts.iframe ? (this.$iframe = h('<iframe src="about:blank" frameBorder="0">'), this.$wp = h("<div></div>"), this.$box.html(this.$wp), this.$wp.append(this.$iframe), this.$iframe.get(0).contentWindow.document.open(), this.$iframe.get(0).contentWindow.document.write("<!DOCTYPE html>"), this.$iframe.get(0).contentWindow.document.write("<html><head></head><body></body></html>"), this.$iframe.get(0).contentWindow.document.close(), this.iframe_document = this.$iframe.get(0).contentWindow.document, this.$el = h(this.iframe_document.querySelector("body")), this.el = this.$el.get(0), this.$head = h(this.iframe_document.querySelector("head")), this.$html = h(this.iframe_document.querySelector("html"))) : (this.$el = h(this.o_doc.createElement("DIV")), this.el = this.$el.get(0), this.$wp = h(this.o_doc.createElement("DIV")).append(this.$el), this.$box.html(this.$wp)), setTimeout(L.bind(this), 0) }.bind(this),
            ...
            r = function() { this.$el = this.$oel, this.el = this.$el.get(0), this.$el.attr("contenteditable", !0).css("outline", "none").css("display", "inline-block"), this.opts.multiLine = !1, this.opts.toolbarInline = !1, setTimeout(L.bind(this), 0) }.bind(this),
            o = function() { this.$el = this.$oel, this.el = this.$el.get(0), this.opts.toolbarInline = !1, setTimeout(L.bind(this), 0) }.bind(this),
            i = function() { this.$el = this.$oel, this.el = this.$el.get(0), this.opts.toolbarInline = !1, this.$oel.on("click.popup", function(e) { e.preventDefault() }), setTimeout(L.bind(this), 0) }.bind(this);
        ...
        for (var t in e)
            if (Object.prototype.hasOwnProperty.call(e, t)) { if (this[t]) continue; if (b.PLUGINS[t] && this.opts.pluginsEnabled.indexOf(t) < 0) continue; if (this[t] = new e[t](this), this[t]._init && (this[t]._init(), this.opts.initOnClick && "core" === t)) return !1 }
