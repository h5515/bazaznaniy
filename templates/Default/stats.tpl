<article class="box story">
	<div class="box_in dark_top stats_head">
		...
		<ul>
			<li class="stats_d"><b>За сутки</b> <span>{news_day} статей и {comm_day} комментариев, зарегистрировано {user_day} пользователей</span></li>
			<li class="stats_w"><b>За неделю</b> <span>{news_week} статей и {comm_week} комментариев, зарегистрировано {user_week} пользователей</span></li>
			<li class="stats_m"><b>За месяц</b> <span>{news_month} статей и {comm_month} комментариев, зарегистрировано {user_month} пользователей</span></li>
		</ul>
	</div>
	<div class="box_in">
		<div class="statistics">
			<div class="stat_group">
				<h5 class="blue">Статьи</h5>
				<ul>
					<li>Общее кол-во статей <b class="right">{news_num}</b></li>
