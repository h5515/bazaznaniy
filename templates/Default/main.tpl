      ...
      <div class="header">
        <div class="wrp">
          <div class="midside">
            <div id="header_menu"> 
              <!-- Логотип --> 
              <a class="logotype" href="/"> <span class="logo_icon"><img src="images/logo.ico" width="42" height="42" alt="" /></span> <span class="logo_title">База знаний ФТО</span> </a> 
              <!-- / Логотип --> 
              <!-- Основное Меню -->
              [not-dostup]
              ...
              <!-- / Кнопка вызова параметров --> 
              <!-- Кнопка вызова меню -->
              <button id="mobile_menu_btn"> <span class="menu_toggle"> <i class="mt_1"></i><i class="mt_2"></i><i class="mt_3"></i> </span> <span class="menu_toggle__title"> Меню </span> </button>
              <!-- / Кнопка вызова меню --> 
              {login} 
              <!-- Кнопка вызова меню -->
        ...
        <section id="content"> {info}
          ...
          <!-- Поиск -->
            ...
            <div class="q_search">
              ...
              <button class="btn q_search_btn" type="submit" title="Найти" onClick="document.location.href = '/index.php?do=search&amp;mode=advanced'">
              <svg class="icon icon-search">
                <use xlink:href="#icon-search"></use>
              </svg>
