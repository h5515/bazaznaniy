...
-- Дамп структуры для таблица bz_novaya_baza.dle_category
...
-- Дамп данных таблицы bz_novaya_baza.dle_category: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_category` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_category` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_category_face
...
-- Дамп данных таблицы bz_novaya_baza.dle_category_face: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_category_face` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_category_face` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_comments
...
-- Дамп данных таблицы bz_novaya_baza.dle_comments: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_comments` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_comments` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_comments_files
...
-- Дамп данных таблицы bz_novaya_baza.dle_comments_files: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_comments_files` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_comments_files` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_comment_rating_log
...
-- Дамп данных таблицы bz_novaya_baza.dle_comment_rating_log: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_comment_rating_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_comment_rating_log` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_draft
...
-- Дамп данных таблицы bz_novaya_baza.dle_draft: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_draft` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_draft` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_files
...
-- Дамп данных таблицы bz_novaya_baza.dle_files: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_files` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_files` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_ignore_list
...
-- Дамп данных таблицы bz_novaya_baza.dle_ignore_list: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_ignore_list` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_ignore_list` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_images
...
-- Дамп данных таблицы bz_novaya_baza.dle_images: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица bz_novaya_baza.dle_links
...
-- Дамп данных таблицы bz_novaya_baza.dle_links: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_links` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_links` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_login_log
...
-- Дамп данных таблицы bz_novaya_baza.dle_login_log: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_login_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_login_log` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_logs
...
-- Дамп данных таблицы bz_novaya_baza.dle_logs: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_logs` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_lostdb
...
-- Дамп данных таблицы bz_novaya_baza.dle_lostdb: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_lostdb` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_lostdb` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_mail_log
...
-- Дамп данных таблицы bz_novaya_baza.dle_mail_log: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_mail_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_mail_log` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_metatags
...
-- Дамп данных таблицы bz_novaya_baza.dle_metatags: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_metatags` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_metatags` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_notice
...
-- Дамп данных таблицы bz_novaya_baza.dle_notice: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_notice` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_notice` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_plugins
...
-- Дамп данных таблицы bz_novaya_baza.dle_plugins: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_plugins` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_plugins` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_plugins_files
...
-- Дамп данных таблицы bz_novaya_baza.dle_plugins_files: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_plugins_files` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_plugins_files` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_plugins_logs
...
-- Дамп данных таблицы bz_novaya_baza.dle_plugins_logs: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_plugins_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_plugins_logs` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_poll
...
-- Дамп данных таблицы bz_novaya_baza.dle_poll: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_poll` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_poll` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_poll_log
...
-- Дамп данных таблицы bz_novaya_baza.dle_poll_log: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_poll_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_poll_log` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_post
...
-- Дамп данных таблицы bz_novaya_baza.dle_post: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица bz_novaya_baza.dle_post_arhiv
...
-- Дамп данных таблицы bz_novaya_baza.dle_post_arhiv: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_post_arhiv` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_post_arhiv` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_post_extras
...
-- Дамп данных таблицы bz_novaya_baza.dle_post_extras: ~1 rows (приблизительно)
...
-- Дамп структуры для таблица bz_novaya_baza.dle_post_extras_cats
...
-- Дамп данных таблицы bz_novaya_baza.dle_post_extras_cats: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица bz_novaya_baza.dle_post_log
...
-- Дамп данных таблицы bz_novaya_baza.dle_post_log: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_post_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_post_log` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_post_pass
...
-- Дамп данных таблицы bz_novaya_baza.dle_post_pass: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_post_pass` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_post_pass` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_post_read
...
-- Дамп данных таблицы bz_novaya_baza.dle_post_read: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица bz_novaya_baza.dle_question
...
-- Дамп данных таблицы bz_novaya_baza.dle_question: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_question` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_question` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_read_log
...
-- Дамп данных таблицы bz_novaya_baza.dle_read_log: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_read_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_read_log` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_redirects
...
-- Дамп данных таблицы bz_novaya_baza.dle_redirects: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_redirects` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_redirects` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_rss
...
-- Дамп данных таблицы bz_novaya_baza.dle_rss: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_rss` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_rss` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_rssinform
...
-- Дамп данных таблицы bz_novaya_baza.dle_rssinform: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_rssinform` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_rssinform` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_sendlog
...
-- Дамп данных таблицы bz_novaya_baza.dle_sendlog: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_sendlog` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_sendlog` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_statmenu
...
-- Дамп данных таблицы bz_novaya_baza.dle_statmenu: 0 rows
/*!40000 ALTER TABLE `dle_statmenu` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_statmenu` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_subscribe
...
-- Дамп данных таблицы bz_novaya_baza.dle_subscribe: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_subscribe` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_subscribe` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_tags
...
-- Дамп данных таблицы bz_novaya_baza.dle_tags: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_tags` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_tags` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_users
...
-- Дамп данных таблицы bz_novaya_baza.dle_users: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_users` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_users` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_views
...
-- Дамп данных таблицы bz_novaya_baza.dle_views: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_views` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_views` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_vote
...
-- Дамп данных таблицы bz_novaya_baza.dle_vote: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_vote` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_vote` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_vote_result
...
-- Дамп данных таблицы bz_novaya_baza.dle_vote_result: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `dle_vote_result` DISABLE KEYS */;
/*!40000 ALTER TABLE `dle_vote_result` ENABLE KEYS */;

-- Дамп структуры для таблица bz_novaya_baza.dle_xfsearch
...
-- Дамп данных таблицы bz_novaya_baza.dle_xfsearch: ~0 rows (приблизительно)
