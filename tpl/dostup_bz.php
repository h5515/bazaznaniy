...
<div class="dostupbutend">
    ...
    <button type="button" data-role="button" data-icon="save" class="k-button-solid-primary" style="display: none;"
        onclick="">Сохранить</button>
    <button type="button" data-role="button" data-icon="close-outline" style="display: none;"
        onclick="windostup.close();">Отмена</button>
</div>
