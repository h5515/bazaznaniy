...
if ( !$allow_addnews ) {
  ...
  if ( isset( $_REQUEST[ 'mod' ] )AND $_REQUEST[ 'mod' ] == "addnews"
    ...
    if ( $alt_name == ""
      OR!$alt_name )$alt_name = totranslit( stripslashes( $title ), true, false );
   ...
   $sql = 'SELECT name FROM dle_users ORDER BY name';
