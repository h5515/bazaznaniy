...
if(!$news_id) die("������! ������������� �������� � ���������� �����!");
if(!$template = file_get_contents(ROOT_DIR."/templates/{$config['skin']}/ajax_news_full.tpl"))die("������! �� ���������� ��������� ������ ����");
...
else $full_story = preg_replace("#\[hide\](.+?)\[/hide\]#ims", "<div class=\"quote\">������� �����</div>", $full_story);
